        ...
        <div class="card">
          ...
          <div class="card-body">
            <form @submit.prevent="submitForm">
              ...
              <div class="form-group row">
                <label for="motivo" class="col-md-4 col-form-label">Historia medica</label>
                <div class="col-md-8">
              ...
              <div class="form-group row">
                <label for="observaciones" class="col-md-4 col-form-label">Historia Odontologica</label>
                <div class="col-md-8">
              ...
              <div class="form-group row">
                <label for="adiagnosticos" class="col-md-4 col-form-label">Examen radiografico</label>
                <div class="col-md-8">
              ...
              <div class="form-group row">
                <label for="pla_tratamiento" class="col-md-4 col-form-label">Plan de tratamiento </label>
                <div class="col-md-8">
                  <textarea v-model="cita.pla_tratamiento" class="form-control" id="pla_tratamiento" rows="3"></textarea>
                </div>
              </div>

              <div class="form-group row">
                <div class="col-md-4 offset-md-2">
                  <button type="submit" class="btn btn-success">{{ isEditMode ? 'Guardar' : 'Guardar' }}</button>
                </div>
...
// Muestra la alerta después de guardar o actualizar
Swal.fire({
  icon: 'success',
  title: 'Éxito',
  text: message || 'La cita se ha guardado correctamente.',
