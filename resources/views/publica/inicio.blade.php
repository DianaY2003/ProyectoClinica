                ...
                <div class="items-center justify-center md:hidden w-full bg-blue-600 shadow-lg rounded-lg" id="mobile-menu">
                    <nav class="py-2"> <!-- Altura reducida -->
                        <ul class="space-y-2">
                            ...
                            <li class="text-center">
                                <a class="block py-2 text-white bg-blue-500 rounded transition duration-200 hover:bg-blue-400" href="/resources/views/trabajosD.blade.php">Servicios Dentales</a>
                            </li>
                            <li class="text-center">
