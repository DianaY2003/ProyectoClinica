...
<body class="antialiased font-sans text-gray-900">
    ...
    <main class="w-full">
        <header class="absolute top-0 left-0 w-full z-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 bg-[#03bfae] shadow-none">
            <div class="flex flex-wrap items-center justify-between py-6">
                ...
                <div class="hidden md:block w-full md:w-auto" id="menu">
                    <nav class="w-full md:bg-[#03bfae] rounded shadow-none px-6 py-4 mt-4 text-center md:p-0 md:mt-0">
        ...
        <div>
            <section class="cover bg-blue-teal-gradient relative bg-blue-500 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex items-center min-h-screen">
