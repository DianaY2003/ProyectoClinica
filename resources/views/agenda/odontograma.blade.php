...
<body>
    <input type="button" value="Descargar" class="js_boton" />
            ...
            <table class="js_content" style="border-collapse:collapse">
                ...
                <tr>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_18.png')}}"class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_17.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_16.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_15.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_14.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_13.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_12.png')}}" class="noevent" />
                    </td>
                    <td style="border-right:1px solid">
                        <img src="{{asset('/Imagen/diente_11.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_21.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_22.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_23.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_24.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_25.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_26.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_27.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_28.png')}}" class="noevent" />
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align:center"></td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_55.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_54.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_53.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_52.png')}}"class="noevent" />
                    </td>
                    <td style="border-right:1px solid;text-align:center">
                        <img src="{{asset('/Imagen/diente_51.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_61.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_62.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_63.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_64.png')}}"class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_65.png')}}" class="noevent" />
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_85.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_84.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_83.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_82.png')}}" class="noevent" />
                    </td>
                    <td style="border-right:1px solid;text-align:center">
                        <img src="{{asset('/Imagen/diente_81.png')}}" class="noevent" />
                    </td>

                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_71.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_72.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_73.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_74.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_75.png')}}" class="noevent" />
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td style="text-align:center">
                        ...
                        <img src="{{asset('/Imagen/diente_48.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_47.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_46.png')}}"  class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_45.png')}}"  class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_44.png')}}"  class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_43.png')}}"  class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_42.png')}}"  class="noevent" />
                    </td>
                    <td style="border-right:1px solid;text-align:center">
                        <img src="{{asset('/Imagen/diente_41.png')}}"  class="noevent" />
                    </td>

                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_31.png')}}"  class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_32.png')}}"class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_33.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_34.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_35.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_36.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_37.png')}}" class="noevent" />
                    </td>
                    <td style="text-align:center">
                        <img src="{{asset('/Imagen/diente_38.png')}}" class="noevent" />
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tbody id="ulOpciones_cv_EO_Odontograma">
                    ...
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Ortodontico_fijo.png" data-order="0" style="">
                            <img src="{{asset('/Imagen/Ortodontico_fijo.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Ortodontico_Removible.png" data-order="1" style="">
                            <img src="{{asset('/Imagen/Ortodontico_Removible.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="caries.png" data-order="2" style="">
                            <img src="{{asset('/Imagen/caries.png')}}"  style="width: 20px;">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Corona_Definitiva.png" data-order="3" style="">
                            <img src="{{asset('/Imagen/Corona_Definitiva.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Corona_Temporal.png" data-order="4" style="">
                            <img src="{{asset('/Imagen/Corona_Temporal.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Oclusal_Incisal.png" data-order="5" style="">
                            <img src="{{asset('/Imagen/Oclusal_Incisal.png')}}" style="width: 20px;">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Diastema.png" data-order="6" style="">
                            <img src="{{asset('/Imagen/Diastema.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Diente_Ausente.png" data-order="7" style="">
                            <img src="{{asset('/Imagen/Diente_Ausente.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Discromico.png" data-order="8" style="">
                            <img src="{{asset('/Imagen/Discromico.png')}}" style="width: 20px;">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Ectopico.png" data-order="9" style="">
                            <img src="{{asset('/Imagen/Ectopico.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Diente_Extruido.png" data-order="11" style="">
                            <img src="{{asset('/Imagen/Diente_Extruido.png')}}" style="width: 20px;">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Diente_Intruido.png" data-order="12" style="">
                            <img src="{{asset('/Imagen/Diente_Intruido.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Edentulo_Total.png" data-order="13" style="">
                            <img src="{{asset('/Imagen/Edentulo_Total.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Trataminto_Pulpar_Por_Realizar_Der.png" data-order="14" style="">
                            <img src="{{asset('/Imagen/Trataminto_Pulpar_Por_Realizar_Der.png')}}" style="width: 20px;">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Geminacion_Fusion.png" data-order="15" style="">
                            <img src="{{asset('/Imagen/Geminacion_Fusion.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Impactacion.png" data-order="16" style="">
                            <img src="{{asset('/Imagen/Impactacion.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Implante.png" data-order="17" style="">
                            <img src="{{asset('/Imagen/Implante.png')}}" style="width: 20px;">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Macrodoncia.png" data-order="18" style="">
                            <img src="{{asset('/Imagen/Macrodoncia.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Microdoncia.png" data-order="19" style="">
                            <img src="{{asset('/Imagen/Microdoncia.png')}}"  style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Migracion_Der.png" data-order="20" style="">
                            <img src="{{asset('/Imagen/Migracion_Der.png')}}" style="width: 20px;">
                        </td>
                    </tr>
                    <tr>
                        <td class="opcs" data-opc="" title="Migración" style="text-align: left; font-weight: 600; text-overflow: ellipsis; height: 30px; width: 8%;">
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Migracion_Izq.png" data-order="21" style="">
                            <img src="{{asset('/Imagen/Migracion_Izq.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Movilidad.png" data-order="22" style="">
                            <img src="{{asset('/Imagen/Movilidad.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Protesis_Fija.png" data-order="23" style="">
                            <img src="{{asset('/Imagen/Protesis_Fija.png')}}" style="width: 20px;">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Protesis_Removible.png" data-order="24" style="">
                            <img src="{{asset('/Imagen/Protesis_Removible.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Protesis_Total.png" data-order="25" style="">
                            <img src="{{asset('/Imagen/Protesis_Total.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Remanente_Radicular.png" data-order="26" style="">
                            <img src="{{asset('/Imagen/Remanente_Radicular.png')}}"  style="width: 20px;">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Restaruracion.png" data-order="27" style="">
                            <img src="{{asset('/Imagen/Restaruracion.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Restauracion_Temporal.png" data-order="28" style="">
                            <img src="{{asset('/Imagen/Restauracion_Temporal.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Semi_Impactacion.png" data-order="29" style="">
                            <img src="{{asset('/Imagen/Semi_Impactacion.png')}}" style="width: 20px;">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Supernumerario.png" data-order="30" style="">
                            <img src="{{asset('/Imagen/Supernumerario.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Tratamiento_Pulpar_Realizado.png" data-order="31" style="">
                            <img src="{{asset('/Imagen/Tratamiento_Pulpar_Realizado.png')}}" style="width: 20px;">
                        </td>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Giroversion.png" data-order="32" style="">
                            <img src="{{asset('/Imagen/Giroversion.png')}}" style="width: 20px;">
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="opcs" data-opc="IMAGE" data-url="Transposicion.png" data-order="33" style="">
                            <img src="{{asset('/Imagen/Transposicion.png')}}" style="width: 20px;">
                        </td>
                    </tr>
                </tbody>
            </table>
...
function moverImagen(e) {
    ...
    // Mover la imagen mientras se mantiene presionado el mouse
    function moverMouse(e) {
        e.preventDefault();
        let x = e.clientX;
        let y = e.clientY;
        imagen.style.top = (y - dy) + 'px';
        imagen.style.left = (x - dx) + 'px';
    }
    ...
    function soltarMouse() {
        ...
        imagenesMovidas.push(imagenMovid);
        localStorage.setItem("imagenesMovidas", JSON.stringify(imagenesMovidas));
    }
...
function restaurarImagenesMovidas() {
    let imagenesMovidasGuardadas = localStorage.getItem("imagenesMovidas");
    if (imagenesMovidasGuardadas) {
        imagenesMovidas = JSON.parse(imagenesMovidasGuardadas);
        
        // Primero eliminar las imágenes existentes en el contenedor
        let contenedor = document.querySelector('.tu-contenedor'); // Cambia esto a tu contenedor
        contenedor.innerHTML = ''; // Limpiar el contenedor

        // Luego, agregar las imágenes en el orden guardado
        imagenesMovidas.forEach(imagenMovid => {
            let imagen = document.getElementById(imagenMovid.id);
            if (imagen) {
                imagen.style.position = 'absolute';
                imagen.style.top = imagenMovid.top + 'px';
                imagen.style.left = imagenMovid.left + 'px';
                contenedor.appendChild(imagen); // Reinsertar en el contenedor
            }
        });
    }
}
...
window.onload = function() {
    ...
    imagenes.forEach(imagen => {
        imagen.addEventListener('mousedown', moverImagen);
    });
    restaurarImagenesMovidas();
}
...
window.onload = function () {
    ...
    js_boton.onclick = async function () {
       ...
       let base64=await html2canvas(el, {
            ...
            aDownload.download = "Odontograma.png";
            aDownload.click();
